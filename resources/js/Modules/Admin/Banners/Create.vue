...
<template>
    ...
    <AdminLayout>
        <h1 class="text-2xl font-bold">Novo banner</h1>
        ...
        <form class="mt-6 max-w-xl space-y-4" enctype="multipart/form-data" @submit.prevent="submit">
            ...
            <div>
                ...
                <div class="mt-1 flex cursor-pointer flex-col items-center justify-center rounded border-2 border-dashed border-gray-300 px-6 py-10 text-center hover:border-gray-400"
                    ...
                    <img v-if="preview" :src="preview" class="mb-2 h-24 rounded object-cover">
                    <i v-else class="fas fa-cloud-upload-alt mb-2 text-2xl text-gray-400"></i>
                    <p class="text-sm text-gray-500">Clique para selecionar a imagem do banner</p>
